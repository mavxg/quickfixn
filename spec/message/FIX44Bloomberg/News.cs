...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class News : Message
        {
            ...
            public uint? EncodedHeadlineLen { get; set; }
            [XmlIgnore]
            public bool EncodedHeadlineLenSpecified { get { return EncodedHeadlineLen.HasValue; } }
            public string EncodedHeadline { get; set; }
            [XmlArray("NoRoutingIDs")]
            public RoutingID[] NoRoutingIDs { get; set; }
            ...
            public partial class RoutingID
            {
                ...
                [XmlIgnore]
                public bool RoutingTypeSpecified { get { return RoutingType.HasValue; } }
                [XmlElement("RoutingID")]
            ...
            public partial class LinesOfText
            {
