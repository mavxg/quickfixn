...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class AssignmentReport : Message
        {
            ...
            public string MsgType { get { return "AW"; } set {} }

            public string AsgnRptID { get; set; }
            public int? TotNumAssignmentReports { get; set; }
            [XmlIgnore]
            public bool TotNumAssignmentReportsSpecified { get { return TotNumAssignmentReports.HasValue; } }
            ...
            [XmlIgnore]
            public bool AssignmentUnitSpecified { get { return AssignmentUnit.HasValue; } }
            public double? OpenInterest { get; set; }
            [XmlIgnore]
            public bool OpenInterestSpecified { get { return OpenInterest.HasValue; } }
