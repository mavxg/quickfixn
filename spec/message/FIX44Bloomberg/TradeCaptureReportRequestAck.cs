...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class TradeCaptureReportRequestAck : Message
        {
            ...
            public string MsgType { get { return "AQ"; } set {} }

            public string TradeRequestID { get; set; }
            public int? TradeRequestType { get; set; }
            [XmlIgnore]
            public bool TradeRequestTypeSpecified { get { return TradeRequestType.HasValue; } }
            ...
            [XmlIgnore]
            public bool TradeRequestResultSpecified { get { return TradeRequestResult.HasValue; } }
            public int? TradeRequestStatus { get; set; }
            [XmlIgnore]
            public bool TradeRequestStatusSpecified { get { return TradeRequestStatus.HasValue; } }
