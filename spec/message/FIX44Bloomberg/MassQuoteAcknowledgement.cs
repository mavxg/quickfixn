...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class MassQuoteAcknowledgement : Message
        {
            ...
            public string MsgType { get { return "b"; } set {} }

            public string QuoteReqID { get; set; }
            public string QuoteID { get; set; }
            public int? QuoteStatus { get; set; }
            [XmlIgnore]
            public bool QuoteStatusSpecified { get { return QuoteStatus.HasValue; } }
            public int? QuoteRejectReason { get; set; }
            [XmlIgnore]
            public bool QuoteRejectReasonSpecified { get { return QuoteRejectReason.HasValue; } }
            ...
            [XmlArray("NoQuoteSets")]
            public QuoteSet[] NoQuoteSets { get; set; }
            ...
            public partial class QuoteSet
            {
                ...
                [XmlIgnore]
                public bool TotNoQuoteEntriesSpecified { get { return TotNoQuoteEntries.HasValue; } }
                ...
                public partial class QuoteEntrie
                {
                    ...
                    [XmlIgnore]
                    public bool QuoteEntryRejectReasonSpecified { get { return QuoteEntryRejectReason.HasValue; } }
