...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class IndicationOfInterest : Message
        {
            ...
            public string MsgType { get { return "6"; } set {} }
            ...
            [XmlArray("NoIOIQualifiers")]
            public IOIQualifier[] NoIOIQualifiers { get; set; }
            ...
            public partial class IOIQualifier
            {
            
                [XmlElement("IOIQualifier")]
                public string Id { get; set; }
