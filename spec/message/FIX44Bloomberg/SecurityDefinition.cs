...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class SecurityDefinition : Message
        {
            ...
            public string MsgType { get { return "d"; } set {} }
            ...
            [XmlIgnore]
            public bool RoundLotSpecified { get { return RoundLot.HasValue; } }
            public double? MinTradeVol { get; set; }
            [XmlIgnore]
            public bool MinTradeVolSpecified { get { return MinTradeVol.HasValue; } }
