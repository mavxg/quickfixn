...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class QuoteRequestReject : Message
        {
            ...
            public string MsgType { get { return "AG"; } set {} }

            public string QuoteReqID { get; set; }
            public string RFQReqID { get; set; }
            public int? QuoteRequestRejectReason { get; set; }
            [XmlIgnore]
            public bool QuoteRequestRejectReasonSpecified { get { return QuoteRequestRejectReason.HasValue; } }
            ...
            [XmlIgnore]
            public bool QuotePriceTypeSpecified { get { return QuotePriceType.HasValue; } }
            ...
            public partial class RelatedSym
            {
                ...
                [XmlIgnore]
                public bool QuoteRequestTypeSpecified { get { return QuoteRequestType.HasValue; } }
