...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class CollateralInquiryAck : Message
        {
            ...
            public string MsgType { get { return "BG"; } set {} }

            public string CollInquiryID { get; set; }
            public int? CollInquiryStatus { get; set; }
            [XmlIgnore]
            public bool CollInquiryStatusSpecified { get { return CollInquiryStatus.HasValue; } }
            public int? CollInquiryResult { get; set; }
            [XmlIgnore]
            public bool CollInquiryResultSpecified { get { return CollInquiryResult.HasValue; } }
