...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class CollateralResponse : Message
        {
            ...
            public string MsgType { get { return "AZ"; } set {} }
            ...
            [XmlIgnore]
            public bool CollAsgnReasonSpecified { get { return CollAsgnReason.HasValue; } }
            public int? CollAsgnTransType { get; set; }
            [XmlIgnore]
            public bool CollAsgnTransTypeSpecified { get { return CollAsgnTransType.HasValue; } }
            public int? CollAsgnRespType { get; set; }
            [XmlIgnore]
            public bool CollAsgnRespTypeSpecified { get { return CollAsgnRespType.HasValue; } }
            public int? CollAsgnRejectReason { get; set; }
            [XmlIgnore]
            public bool CollAsgnRejectReasonSpecified { get { return CollAsgnRejectReason.HasValue; } }
            ...
            public partial class Underlying
            {
                ...
                [XmlIgnore]
                public bool CollActionSpecified { get { return CollAction.HasValue; } }
