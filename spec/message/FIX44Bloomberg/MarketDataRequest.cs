...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class MarketDataRequest : Message
        {
            ...
            [XmlIgnore]
            public bool MarketDepthSpecified { get { return MarketDepth.HasValue; } }
            public int? MDUpdateType { get; set; }
            [XmlIgnore]
            public bool MDUpdateTypeSpecified { get { return MDUpdateType.HasValue; } }
            public string AggregatedBook { get; set; }
            public string OpenCloseSettlFlag { get; set; }
            public string Scope { get; set; }
            public string MDImplicitDelete { get; set; }
            [XmlArray("NoMDEntryTypes")]
            public MDEntryType[] NoMDEntryTypes { get; set; }
            ...
            [XmlIgnore]
            public bool ApplQueueActionSpecified { get { return ApplQueueAction.HasValue; } }
            public int? ApplQueueMax { get; set; }
            [XmlIgnore]
            public bool ApplQueueMaxSpecified { get { return ApplQueueMax.HasValue; } }

            public partial class MDEntryType
            {
            
                [XmlElement("MDEntryType")]
