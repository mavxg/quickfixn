...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class MassQuote : Message
        {
            ...
            public string MsgType { get { return "i"; } set {} }
            ...
            [XmlIgnore]
            public bool DefBidSizeSpecified { get { return DefBidSize.HasValue; } }
            public double? DefOfferSize { get; set; }
            [XmlIgnore]
            public bool DefOfferSizeSpecified { get { return DefOfferSize.HasValue; } }
