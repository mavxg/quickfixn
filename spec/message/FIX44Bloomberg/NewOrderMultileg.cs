...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class NewOrderMultileg : Message
        {
            ...
            public string MsgType { get { return "AB"; } set {} }
            ...
            [XmlIgnore]
            public bool MultiLegRptTypeReqSpecified { get { return MultiLegRptTypeReq.HasValue; } }
            ...
            public partial class Alloc
            {
                ...
                [XmlArray("NoNested3PartyIDs")]
                public Nested3PartyID[] NoNested3PartyIDs { get; set; }
                public double? AllocQty { get; set; }
                [XmlIgnore]
                public bool AllocQtySpecified { get { return AllocQty.HasValue; } }
            
                public partial class Nested3PartyID
                {
                
                    [XmlElement("Nested3PartyID")]
                    public string Id { get; set; }
                    public string Nested3PartyIDSource { get; set; }
                    public int? Nested3PartyRole { get; set; }
                    [XmlIgnore]
                    public bool Nested3PartyRoleSpecified { get { return Nested3PartyRole.HasValue; } }
                    [XmlArray("NoNested3PartySubIDs")]
                    public Nested3PartySubID[] NoNested3PartySubIDs { get; set; }
                
                    public partial class Nested3PartySubID
                    {
                    
                        [XmlElement("Nested3PartySubID")]
                        public string Id { get; set; }
                        public int? Nested3PartySubIDType { get; set; }
                        [XmlIgnore]
                        public bool Nested3PartySubIDTypeSpecified { get { return Nested3PartySubIDType.HasValue; } }
            ...
            public partial class Leg
            {
                ...
                [XmlArray("NoLegAllocs")]
                public LegAlloc[] NoLegAllocs { get; set; }
                ...
                public partial class LegAlloc
                {
                    ...
                    [XmlIgnore]
                    public bool LegAllocQtySpecified { get { return LegAllocQty.HasValue; } }
