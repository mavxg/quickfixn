...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class Email : Message
        {
            ...
            public string MsgType { get { return "C"; } set {} }

            public string EmailThreadID { get; set; }
            public string EmailType { get; set; }
            public string OrigTime { get; set; }
            public string Subject { get; set; }
            public uint? EncodedSubjectLen { get; set; }
            [XmlIgnore]
            public bool EncodedSubjectLenSpecified { get { return EncodedSubjectLen.HasValue; } }
