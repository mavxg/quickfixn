...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class OrderMassCancelReport : Message
        {
            ...
            [XmlIgnore]
            public bool TotalAffectedOrdersSpecified { get { return TotalAffectedOrders.HasValue; } }
            [XmlArray("NoAffectedOrders")]
            public AffectedOrder[] NoAffectedOrders { get; set; }
            ...
            public partial class AffectedOrder
            {
