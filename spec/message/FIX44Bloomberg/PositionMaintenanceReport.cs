...
namespace Oath.Domain.Schema
{
    namespace FIX44Bloomberg 
    {
        public class PositionMaintenanceReport : Message
        {
            ...
            public string MsgType { get { return "AM"; } set {} }

            public string PosMaintRptID { get; set; }
            public int? PosTransType { get; set; }
            [XmlIgnore]
            public bool PosTransTypeSpecified { get { return PosTransType.HasValue; } }
            public string PosReqID { get; set; }
            public int? PosMaintAction { get; set; }
            [XmlIgnore]
            public bool PosMaintActionSpecified { get { return PosMaintAction.HasValue; } }
            public string OrigPosReqRefID { get; set; }
            public int? PosMaintStatus { get; set; }
            [XmlIgnore]
            public bool PosMaintStatusSpecified { get { return PosMaintStatus.HasValue; } }
            public int? PosMaintResult { get; set; }
            [XmlIgnore]
            public bool PosMaintResultSpecified { get { return PosMaintResult.HasValue; } }
            ...
            [XmlIgnore]
            public bool AdjustmentTypeSpecified { get { return AdjustmentType.HasValue; } }
            public double? ThresholdAmount { get; set; }
            [XmlIgnore]
            public bool ThresholdAmountSpecified { get { return ThresholdAmount.HasValue; } }
