...
namespace QuickFix.Fields
{
    ...
    public static class Tags
    {
        ...
        public const int AssumedCoupon = 5518;
        public const int PrepaymentSpeed = 5519;
        public const int Haircut = 5525;
        public const int AllInPrice = 5526;
        public const int LegLastSpotRate = 5190;
        public const int LegLastForwardPoints = 1073;
        public const int LegSplitTradeFlag = 5192;
        public const int LegMarketType = 5193;
        public const int TradingSystemTicketNumber = 9009;
        public const int TradingSystemRefTicketNumber = 9010;
        public const int FXMarketType = 9102;
        public const int NoTickets = 9103;
        public const int RepeatingTicketNo = 9104;
        public const int FixingDate = 6203;
        public const int LastQty2 = 6808;
        public const int Checkout = 9105;
        public const int Strategy = 9107;
        public const int BBExecSubType = 9150;
        public const int NoTransactionCosts = 9471;
        public const int TransactionCostType = 9472;
        public const int TransactionCostCode = 9473;
        public const int TransactionCostRate = 9474;
        public const int TransactionCostFlag = 9475;
        public const int TransactionCostAmt = 9476;
        public const int TransasctionCostCurr = 9477;
        public const int NoNotes = 9610;
        public const int NoteType = 9611;
        public const int NoteId = 9612;
        public const int NoteText = 9613;
        public const int BLPTicketType = 9654;
        public const int FixedIncomeFlag = 9894;
        public const int FixedIncomeSubFlag = 9895;
        public const int PricingNo = 9896;
        public const int UUID = 9998;
        public const int FirmNo = 9999;
        public const int IOIID = 23;
